...
|---------|------------------|--------|
| `includes/line_level_issues.md` | `{{ file }}:{{ line }}` then `  {{ content }}` if present | too-many-parameters, oversized-function, high-complexity, deep-nesting, unused-variable, unused-import, swallowed-exception, loose-equality, var-declaration, non-const-binding, duplicate-import, explicit-any, non-null-assertion, redundant-type-annotation, warning-comment, non-essential-comment, unchecked-error, copied-lock, interface-pollution, missing-context-propagation, mixed-receiver-types |
